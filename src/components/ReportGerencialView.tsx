          ...
          >
            ...
            <div className="flex items-start justify-between gap-2 shrink-0">
              ...
              <div className="flex flex-col items-end gap-1.5 shrink-0">
                ...
                {discipline.optimizedComment && (
                  <span className="flex items-center gap-1 text-[8px] text-emerald-800 font-bold bg-emerald-50 border border-emerald-100 px-1.5 py-0.5 rounded shadow-sm animate-fade-in">
